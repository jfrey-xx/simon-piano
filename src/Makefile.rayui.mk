...
ifeq ($(MACOS),true)
	$(MAKE) all -C $(RAYUI_PATH)/raylib/src PLATFORM=PLATFORM_DPF GRAPHICS=GRAPHICS_API_OPENGL_33 RAYLIB_MODULE_AUDIO=FALSE RAYLIB_MODULE_RAYGUI=TRUE RAYLIB_MODULE_RAYGUI_PATH=../../ CUSTOM_CFLAGS="-DGL_SILENCE_DEPRECATION"
else
